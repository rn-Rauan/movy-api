...
- **Erros de Domínio**: `MembershipAlreadyExistsError`, `MembershipNotFoundError`, `DriverNotFoundForMembershipError` *(novo 14 Abr → HTTP 400)*, `DriverNotAssociatedWithOrganizationError` *(novo 14 Abr → HTTP 400)*.
